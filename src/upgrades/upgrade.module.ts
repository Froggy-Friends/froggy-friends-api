...
@Module({
  imports: [TypeOrmModule.forFeature([Upgrade]), ContractModule, FrogModule, TraitModule, ConfigModule],
  controllers: [UpgradeController],
  providers: [UpgradeService, ContractService, FrogService, TraitService, ConfigService],
